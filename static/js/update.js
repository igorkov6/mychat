// проверка поступивших сообщений

//получить объекты формы
...
// проверка поступивших сообщений
async function checkForUpdate(url, data, csrftoken) {
    ...
    if (response.ok === true) {
        ...
        // получить сообщение
        const my_dict = await response.json()
        const sender = my_dict["sender"]
        const message = my_dict["message"]
